...
class ArraySerializationTest extends BaseSerializationTest
{
    protected function getContent($key)
    {
        ...
        if (!$outputs) {
            ...
            $outputs['simple_object'] = array('foo' => 'foo', 'moo' => 'bar', 'camel_case' => 'boo');
            $outputs['circular_reference'] = array("collection" => array(array("name" => "child1"),array("name" => "child2")),"another_collection" => array(array("name" => "child1"),array("name" => "child2")));
            ...
            $outputs['array_objects'] = array(array("foo" => "foo", "moo" => "bar", "camel_case" => "boo"), array("foo" => "baz", "moo" => "boo", "camel_case" => "boo"));
            $outputs['array_mixed'] = array("foo", 1, true, array("foo" => "foo", "moo" => "bar", "camel_case" => "boo"), array(1,3,true));
            $outputs['blog_post'] = array("title" => "This is a nice title.","created_at" => "2011-07-30T00:00:00+0000","is_published" => false,"comments" => array(array("author" => array("full_name" => "Foo Bar"),"text" => "foo")),"author" => array("full_name" => "Foo Bar"));
            ...
            $outputs['orm_proxy'] = array("foo" => "foo","moo" => "bar","camel_case" => "proxy-boo");
            ...
            $outputs['mixed_access_types'] = array("id" => 1,"name" => "Johannes","read_only_property" => 42);
            ...
            $outputs['virtual_properties'] = array("exist_field" => "value","virtual_value" => "value","test" => "other-name");
